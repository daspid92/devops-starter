...
public class InMemoryLocations implements Locations {
    ...
    public void setup() {
        ...
        Place campolonghetto = new Place("Campolonghetto", "Friuli", "UD");
        Place udine = new Place("Udine", "Friuli", "UD");
        ...
        map.put(new Query("it", "33050"), new ZipInfo("33050", "Italy", "IT", asList(campolonghetto)));
        map.put(new Query("it", "33100"), new ZipInfo("33100", "Italy", "IT", asList(udine)));
    }
}
